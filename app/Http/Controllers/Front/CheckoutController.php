...
class CheckoutController extends Controller
{
    ...
    public function charge(StripeExecutionRequest $request)
    {
        try {
            ...
            return redirect()->route('checkout.success')->with('message', 'Franja de pago exitosa!');
        } catch (StripeChargingErrorException $e) {
            Log::info($e->getMessage());
            return redirect()->route('checkout.index')->with('error', 'Hay un problema al procesar su solicitud.');
        }
    }

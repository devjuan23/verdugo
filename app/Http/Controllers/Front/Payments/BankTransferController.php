    ...
    public function store(Request $request)
    {
        ...
        if (env('ACTIVATE_SHIPPING') == 1) {
            ...
            if ($transaction['status'] != 'SUCCESS'){
                ...
                return redirect()->route('checkout.index')->with('error', 'Hay un error en los detalles del envío. Revise los registros.');
            }
        ...
        return redirect()->route('accounts', ['tab' => 'orders'])->with('message', 'Order creada con exito!');
    }
}

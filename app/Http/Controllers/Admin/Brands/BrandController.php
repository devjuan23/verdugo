...
class BrandController extends Controller
{
    ...
    public function store(CreateBrandRequest $request)
    {
        ...
        return redirect()->route('admin.brands.index')->with('message', 'Marca creada con exito!');
    }
    ...
    public function update(UpdateBrandRequest $request, $id)
    {
        ...
        return redirect()->route('admin.brands.edit', $id)->with('message', 'Actualizado con exito!');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('admin.brands.index')->with('message', 'Eliminado con exito!');
    }
}

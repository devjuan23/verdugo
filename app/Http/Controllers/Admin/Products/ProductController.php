...
class ProductController extends Controller
{
    ...
    public function store(CreateProductRequest $request)
    {
        ...
        return redirect()->route('admin.products.edit', $product->id)->with('message', 'Actualizado con exito');
    }
    ...
    public function edit(int $id)
    {
        ...
        if (request()->has('delete') && request()->has('pa')) {
            ...
            request()->session()->flash('message', 'Eliminado con exito');
    ...
    public function update(UpdateProductRequest $request, int $id)
    {
        ...
        if ($request->has('attributeValue')) {
            ...
            return redirect()->route('admin.products.edit', [$id, 'combination' => 1])
                ->with('message', 'Combinación de atributos creada con éxito');
        }
        ...
        return redirect()->route('admin.products.edit', $id)
            ->with('message', 'Actializado con éxito');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('admin.products.index')->with('message', 'Eliminado con éxito');
    }

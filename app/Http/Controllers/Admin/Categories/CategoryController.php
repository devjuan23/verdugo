...
class CategoryController extends Controller
{
    ...
    public function store(CreateCategoryRequest $request)
    {
        ...
        return redirect()->route('admin.categories.index')->with('message', 'Categoria creada con exito');
    }
    ...
    public function update(UpdateCategoryRequest $request, $id)
    {
        ...
        $request->session()->flash('message', 'Actualizada con exito');
    ...
    public function destroy(int $id)
    {
        ...
        request()->session()->flash('message', 'Eliminada con exito');
    ...
    public function removeImage(Request $request)
    {
        ...
        request()->session()->flash('message', 'Imagen eliminada con exito');

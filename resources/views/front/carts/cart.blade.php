...
@section('content')
        <div class="container product-in-cart-list">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="btn-group pull-right">
                                    ...
                                    <a href="{{ route('checkout.index') }}" class="btn btn-primary">Ir a la caja</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            @else
                <div class="row">
                    <div class="col-md-12">
                        <p class="alert alert-warning">No hay productos todavía. <a href="{{ route('home') }}">Comprar Ahora!</a></p>
                    </div>
                </div>
            @endif
        </div>

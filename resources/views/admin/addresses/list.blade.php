...
@section('content')
    ...
    <!-- Default box -->
                        ...
                        <table class="table">
                            <thead>
                                <tr>
                                    ...
                                    <td class="col-md-2">Provincia</td>
                                    <td class="col-md-1">Ciudad</td>
                                    <td class="col-md-1">Código postal</td>
                                    <td class="col-md-1">Estado</td>
                                    <td class="col-md-3">Acciónes</td>
                                </tr>
                            </thead>
                            <tbody>
        ...
        @else
            <div class="box">
                <div class="box-body"><p class="alert alert-warning">No se encontraron direcciones.</p></div>
            </div>
        @endif
    </section>
    <!-- /.content -->

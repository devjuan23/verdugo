            ...
            <form action="{{ route('admin.couriers.update', $courier->id) }}" method="post" class="form">
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="name" id="name" placeholder="Nombre" class="form-control" value="{{ $courier->name ?: old('name') }}">
                    </div>
                    <div class="form-group">
                        <label for="description">Descripción </label>
                        <textarea name="description" id="description" rows="5" class="form-control" placeholder="Descripción">{{ $courier->description ?: old('description') }}</textarea>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="is_free">¿Entrega gratis? </label>
                ...
                <div class="box-footer">
                    <div class="btn-group">
                        <a href="{{ route('admin.couriers.index') }}" class="btn btn-default">Atras</a>
